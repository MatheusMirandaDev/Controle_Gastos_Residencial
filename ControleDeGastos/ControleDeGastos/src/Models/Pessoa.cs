...
public class Pessoa
{
    ...
    public decimal TotalReceitas => Transacoes? // Verifica se a lista de transações não é nula
    ...
    public decimal TotalDespesas => Transacoes? // Verifica se a lista de transações não é nula
